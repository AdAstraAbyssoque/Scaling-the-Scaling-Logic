...
PROMPT_TEMPLATES = {
    ...
    "qwen3-base-training": (
        "<|im_start|>system\nYou are a helpful assistant.<|im_end|>\n"
        "<|im_start|>user\n{input}\n"
        "Please reason step by step and include your reasoning within <reasoning> and </reasoning> tags. "
        "Finally provide a brief answer and explanation. And put your final answer within \\boxed{{}}.<|im_end|>\n"
        "<|im_start|>assistant\n",
        "{output}",
        "\n\n",
    ),
